...
func lostPasswordEmailTemplate(urlToken string) string {
	var temps = `
	<!DOCTYPE html>
	<html>
	<head>
	...
	*/
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<td align="center" bgcolor="#e9ecef">
			...
			<tr>
				<td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;">
				<h1 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">Şifre Yenileme</h1>
				</td>
			</tr>
			</table>
		</td>
		...
		<td align="center" bgcolor="#e9ecef">
			...
			<tr>
				<td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
				<p style="margin: 0;">Şifrenizi yenilemek için aşağıdaki düğmeye basın.  <a href="https://benimkinerede.com">BenimkiNerede</a>, ile bir hesap oluşturmadıysanız, bu e-postayı güvenle silebilirsiniz.</p>
				</td>
			</tr>
			<tr>
				<td align="left" bgcolor="#ffffff">
				<table border="0" cellpadding="0" cellspacing="0" width="100%">
					...
					<td align="center" bgcolor="#ffffff" style="padding: 12px;">
						...
						<tr>
							<td align="center" bgcolor="#1a82e2" style="border-radius: 6px;" >
							<a href="` + urlToken + `"target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Şifre Sıfırla</a>
							</td>
						</tr>
						</table>
					</td>
